...
rule AlignmentSummaryMetrics:
    ...
    shell:
        """
        gatk {params} CollectAlignmentSummaryMetrics \
            -R {input.ref} \
            -I {input.bam} \
            -O {output} \
            > {log} 2>&1
...
rule getSegmentCoverage:
    input:
        ...
        gappedbins="genome/hg38.bins."+cnv_binsize+".norepeats.bed",
        bins="genome/hg38.bins."+cnv_binsize+".bed",
...
## get reference npz fils from normal sample npz files
